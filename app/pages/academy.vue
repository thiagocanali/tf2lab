...
@media (max-width: 820px) { .academy-hero, .resource-panel { grid-template-columns: 1fr; }.hero-note { max-width: 28rem; }.section-intro { text-align: left; }.section-heading { align-items: start; flex-direction: column; gap: .75rem; }.class-grid { grid-template-columns: repeat(2, 1fr); }.resource-links { grid-template-columns: repeat(2, 1fr); } }
